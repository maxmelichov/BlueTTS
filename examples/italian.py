...
audio, _ = tts("Ciao, questa è una prova breve in italiano.", lang="it", style=style, total_step=16, cfg_scale=3.0)
if audio.ndim == 2: audio = audio[0]
out = Path("examples/out/italian.wav"); out.parent.mkdir(parents=True, exist_ok=True)
